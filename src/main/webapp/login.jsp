...
/* === Khaalo Premium Dedicated Login Style (Swiggy/Zomato Class) === */
    ...
    <div class="modal-page-overlay">
        ...
        <div class="login-card-container">
            ...
            <div class="form-content-body">
                ...
                %>
                    <div id="loginErrorBanner" style="background: rgba(234, 67, 53, 0.15); border: 1px solid #EA4335; color: #EA4335; padding: 12px; border-radius: 12px; font-size: 0.9rem; font-weight: 600; margin-bottom: 16px; text-align: center;">
                        <%= loginError %>
                    </div>
                <%
                    }
                ...
                <form action="login" method="POST" id="loginForm">
                    ...
                    <button type="submit" class="action-submit-btn">Log In</button>
                </form>
                ...
                <div class="toggle-onboarding-footer">
                    New to Khaalo? <a href="signup.jsp">Sign Up Now</a>
                </div>
            </div>
        </div>
